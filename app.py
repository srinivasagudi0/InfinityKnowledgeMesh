...
def _render_graph(*, layout_choice: str = "Force Atlas") -> None:
    ...
    base_options = """
    var options = {
      nodes: {font: {face: 'Space Grotesk', size: 16}, shape: 'dot', scaling: {min: 8, max: 22}},
    ...
    var options = {
      layout: { hierarchical: { enabled: true, direction: 'UD', sortMethod: 'hubsize', levelSeparation: 140 } },
      nodes: {font: {face: 'Space Grotesk', size: 16}, shape: 'dot', scaling: {min: 8, max: 22}},
      edges: {smooth: false, color: '#8fb3ff'},
      physics: { hierarchicalRepulsion: { nodeDistance: 130, springLength: 140 }, stabilization: true }
    }
    """
